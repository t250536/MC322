...
import com.rpg.ambientacao.cenarios.ConstrutorDeCenarioFixo;
...
import com.rpg.utilidades.InputManager;
...
public class Main {
    ...
    private static void iniciarJogo() {
        ...
        for (int i = 0; i < fases.size(); i++) {
            ...
            if (fase instanceof com.rpg.ambientacao.fases.FaseDeCombate) {
                com.rpg.ambientacao.fases.FaseDeCombate faseCombate = (com.rpg.ambientacao.fases.FaseDeCombate) fase;
