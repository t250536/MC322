...
public class ConstrutorDeCenario {
  ...
  // gerador de drops
  private static List<Arma> geradrops() {
    ...
    for (int i = 0; i < numDrops; i++) {
      ...
      switch (tipoArma) {
        case 0:
          dropsList.add(new Espada(20, 0, "Espada Longa"));
          break;
        case 1:
          dropsList.add(new Machado(25, 0, "Machado de Batalha"));
          break;
        case 2:
          dropsList.add(new Faca(15, 0, "Faca de Arremesso"));
          break;
        case 3:
          dropsList.add(new Espada(30, 0, "Espada de Fogo"));
          break;
        case 4:
          dropsList.add(new Machado(35, 0, "Machado de Gelo"));
          break;
        case 5:
          dropsList.add(new Faca(20, 0, "Faca Venenosa"));
          break;
        case 6:
          dropsList.add(new Espada(25, 0, "Espada Curta"));
          break;
        case 7:
          dropsList.add(new Machado(20, 0, "Machado Leve"));
          break;
        case 8:
          dropsList.add(new Faca(10, 0, "Faca Pequena"));
          break;
        case 9:
          dropsList.add(new Espada(40, 0, "Espada do Dragão"));
          break;
      }
    }
    return dropsList;
      ...
      switch (tipomonstro) {
        ...
        case 2:
          Dragao dragao = new Dragao("Dragão de nivel " + nivel, 15 + nivel * 10, 100 + nivel * 15,
              new Espada(12, 0, "Espada de Obsidiana"), 30 + nivel * 15, dropsList, 0);
          monstros.add(dragao);
